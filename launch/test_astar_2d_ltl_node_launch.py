...
def generate_launch_description():
    ...
    test_astar_2d_ltl_node = Node(
        ...
        parameters=[{
            "automaton_path": PathJoinSubstitution([FindPackageShare("erl_path_planning"), "data", "automaton.aut"]),
            "label_map_image_path": PathJoinSubstitution([FindPackageShare("erl_path_planning"), "data", "label_map.png"]),
        }],
    )
